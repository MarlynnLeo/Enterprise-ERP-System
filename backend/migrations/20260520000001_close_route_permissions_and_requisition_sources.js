const ROUTE_MENUS = [
  ...
  { parentPermission: 'production', name: 'Material Shortage', path: '/production/material-shortage', component: 'production/MaterialShortage', icon: 'Warning', permission: 'production:shortage', sort_order: 50 },
  { parentPermission: 'production', name: 'Production Gantt', path: '/production/gantt', component: 'production/ProductionGantt', icon: 'DataLine', permission: 'production:gantt', sort_order: 90 },
