...
exports.up = async function(knex) {
  ...
  entity_id VARCHAR(500) COMMENT '实体ID',
  ...
  await knex.raw(`CREATE TABLE IF NOT EXISTS inspection_templates (
    ...
    inspection_type ENUM('incoming', 'process', 'final', 'first_article') NOT NULL COMMENT '检验类型',
    material_type BIGINT COMMENT '适用物料ID',
    material_types JSON COMMENT '适用物料ID列表',
    is_general BOOLEAN NOT NULL DEFAULT FALSE COMMENT '是否通用模板',
    is_default BOOLEAN NOT NULL DEFAULT FALSE COMMENT '是否默认兜底模板',
    ...
    is_aql BOOLEAN NOT NULL DEFAULT FALSE COMMENT '是否启用AQL抽样',
    aql_level VARCHAR(20) COMMENT '默认AQL等级',
