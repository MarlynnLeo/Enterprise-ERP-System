...
const salaryRead = [
  authenticateToken,
  requirePermission(['hr:salary:view', 'hr:salary', 'finance:salary:approve']),
];
...
router.post(
  '/employees/sync/dingtalk',
  authenticateToken,
  requirePermission('hr:employees:create'),
  hrController.syncDingtalk
);
router.put(
  '/employees/:id',
  authenticateToken,
...
router.post(
  '/leave',
  authenticateToken,
  requirePermission(['hr:attendance:create', 'hr:attendance:update']),
...
router.post(
  ...
  authenticateToken,
  requirePermission(['hr:attendance:create', 'hr:attendance:update']),
  hrController.createOvertimeRequest
);
...
router.post(
  ...
  hrController.batchSaveAttendance
);
router.post(
  '/attendance/sync/dingtalk',
  authenticateToken,
  requirePermission('hr:attendance:update'),
  hrController.syncAttendance
);
...
router.post(
  ...
  hrController.importAttendanceExcel
);
...
router.post(
  '/salary/calculate',
  authenticateToken,
  requirePermission('hr:salary:update'),
  hrController.calculateSalary
);
router.put(
  '/salary/:id/confirm',
  authenticateToken,
  requirePermission('finance:salary:approve'),
  hrController.confirmSalary
);
router.post(
  '/salary/batch-confirm',
  authenticateToken,
  requirePermission('finance:salary:approve'),
  hrController.batchConfirmSalary
);
router.get(
  '/salary/export',
  authenticateToken,
  requirePermission('hr:salary:view'),
  hrController.exportSalary
);
...
router.put(
  ...
  authenticateToken,
  requirePermission('hr:attendance:update'),
  hrController.updateAttendanceRule
);
