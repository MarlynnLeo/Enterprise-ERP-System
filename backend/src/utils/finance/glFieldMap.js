...
function toBankTransactionApi(row) {
  ...
  return {
    ...
    transactionCategory: row.category ?? row.transaction_category ?? row.transactionCategory ?? null,
    ...
    reconciliationDate: formatDate(row.reconciliation_date ?? row.reconciliationDate),
