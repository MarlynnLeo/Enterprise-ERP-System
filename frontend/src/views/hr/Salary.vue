  ...
  <div class="module-page salary-container">
    <PageHeader title="薪酬核算中心" subtitle="按月核算、确认与导出薪资">
      <template #actions>
        ...
        <el-button
          type="primary"
          v-permission="'finance:salary:approve'"
    ...
    <el-card class="data-card" shadow="never">
      ...
      >
        ...
        <el-table-column prop="calculatedByName" label="核算人" width="110" />
        <el-table-column prop="approvedByName" label="财务审核人" width="110" />
