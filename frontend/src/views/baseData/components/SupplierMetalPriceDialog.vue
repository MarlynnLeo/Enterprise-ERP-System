  ...
  >
    <div v-loading="loading" class="metal-price-dialog">
      ...
      <el-table :data="form.bands" border size="small" class="mb-16">
        ...
        <el-table-column label="操作" min-width="72" fixed="right" class-name="operation-column" header-class-name="operation-column-header"><template #default="{ $index }"><el-button size="small" type="danger" @click="removeBand($index)">删除</el-button></template></el-table-column>
      </el-table>
      ...
      <el-table :data="form.items" border size="small" max-height="420">
        ...
        <el-table-column label="操作" min-width="72" fixed="right" class-name="operation-column" header-class-name="operation-column-header"><template #default="{ $index }"><el-button size="small" type="danger" @click="removeItem($index)">删除</el-button></template></el-table-column>
      </el-table>
    </div>
    <template #footer>
