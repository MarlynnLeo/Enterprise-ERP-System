...
export const PURCHASE_STATUS = {
  DRAFT: 'draft',                      // 草稿
  PENDING: 'pending',                  // 待审批
  CONFIRMED: 'confirmed',              // 已确认（历史状态/非工作流确认）
...
export const PURCHASE_STATUS_TRANSITIONS = {
  ...
  [PURCHASE_STATUS.CONFIRMED]: [PURCHASE_STATUS.RECEIVED, PURCHASE_STATUS.PARTIAL_RECEIVED, PURCHASE_STATUS.CANCELLED],
  [PURCHASE_STATUS.APPROVED]: [PURCHASE_STATUS.RECEIVED, PURCHASE_STATUS.PARTIAL_RECEIVED, PURCHASE_STATUS.CANCELLED],
  ...
  [PURCHASE_STATUS.PARTIAL_RECEIVED]: [PURCHASE_STATUS.RECEIVED, PURCHASE_STATUS.CANCELLED],
...
export const PURCHASE_STATUS_ACTION_TEXT = {
  [PURCHASE_STATUS.DRAFT]: '驳回',
  [PURCHASE_STATUS.PENDING]: '提交审批',
  [PURCHASE_STATUS.CONFIRMED]: '批准',
  [PURCHASE_STATUS.APPROVED]: '批准',
  [PURCHASE_STATUS.RECEIVED]: '确认到货',
