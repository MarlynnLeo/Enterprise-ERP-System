...
export const PURCHASE_STATUS_TRANSITIONS = {
  ...
  [PURCHASE_STATUS.CONFIRMED]: [PURCHASE_STATUS.RECEIVED, PURCHASE_STATUS.PARTIAL_RECEIVED, PURCHASE_STATUS.COMPLETED, PURCHASE_STATUS.CANCELLED],
  [PURCHASE_STATUS.APPROVED]: [PURCHASE_STATUS.RECEIVED, PURCHASE_STATUS.PARTIAL_RECEIVED, PURCHASE_STATUS.COMPLETED, PURCHASE_STATUS.CANCELLED],
