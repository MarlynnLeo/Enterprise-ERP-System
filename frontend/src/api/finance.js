...
export const financeApi = {
  inventoryPostings: {
    ...
    getBySource: (params) => api.get('/finance/inventory-postings/by-source', { params }),
  ...
  glClosing: {
    ...
    updateUnpostedEntryDates: (entryId, data) =>
      api.patch(`/finance/gl/closing/unposted-entries/${entryId}/dates`, data),
    execute: (periodId) => api.post(`/finance/gl/closing/execute/${periodId}`),
    getUnreconciledTransactions: (periodId) =>
      api.get(`/finance/gl/closing/unreconciled/${periodId}`),
  ...
  budgets: {
    ...
    getAiRecommendation: (params, config = {}) =>
      api.get('/finance/budgets/ai/recommendation', { ...config, params }),
    createFromAi: (data, config = {}) =>
      api.post('/finance/budgets/ai/create-from-ai', data, config),
    getAiAnomalies: (id, config = {}) => api.get(`/finance/budgets/${id}/ai/anomalies`, config),
    getAiOptimization: (id, config = {}) =>
      api.get(`/finance/budgets/${id}/ai/optimization`, config),
    getAiYearComparison: (params, config = {}) =>
      api.get('/finance/budgets/ai/year-comparison', { ...config, params }),
    getAiComprehensiveReport: (id, config = {}) =>
      api.get(`/finance/budgets/${id}/ai/comprehensive-report`, config),
  },
  ...
  getARSettlementDashboard: (params) => api.get('/finance/ar/settlement-dashboard', { params }),
  ...
  getAPSettlementDashboard: (params) => api.get('/finance/ap/settlement-dashboard', { params }),

  // 三单匹配 / 业财状态
  createThreeWayMatchFromReceipt: (receiptId, data) =>
    api.post(`/finance/integration/three-way-match/from-receipt/${receiptId}`, data),
  listThreeWayMatches: (params) => api.get('/finance/integration/three-way-match', { params }),
  ...
  bankTransactions: {
    ...
    getTransferRequests: (params) =>
      api.get('/finance/bank-transactions/transfer-requests', { params }),
    create: (data) => api.post('/finance/bank-transactions', data),
    createTransfer: (data) => api.post('/finance/bank-transactions/transfer', data),
    approveTransfer: (id) => api.post(`/finance/bank-transactions/transfers/${id}/approve`),
    rejectTransfer: (id, data) =>
      api.post(`/finance/bank-transactions/transfers/${id}/reject`, data),
    ...
    import: (data) =>
      api.post('/finance/bank-transactions/import', data, {
  ...
  cashTransactions: {
    ...
    import: (data) =>
      api.post('/finance/cash-transactions/import', data, {
        headers: { 'Content-Type': 'multipart/form-data' },
      }),
  ...
  reconciliation: {
    ...
    getMatchedTransaction: (params) =>
      api.get('/finance/cash/reconciliation/matched-transaction', { params }),
    getPossibleMatches: (params) =>
      api.get('/finance/cash/reconciliation/possible-matches', { params }),
    confirmMatch: (data) => api.post('/finance/cash/reconciliation/confirm-match', data),
    cancelReconciliation: (data) =>
      api.post('/finance/cash/reconciliation/cancel-reconciled', data),
  },
  ...
  exportPricingList: (params) =>
    api.get('/finance/pricing/export', { params, responseType: 'blob' }),
  ...
  getBomPriceHistory: (productId, materialId) =>
    api.get(`/finance/bom-price-adjustments/${productId}/${materialId}/history`),
  ...
  cost: {
    ...
    getMaterialStandardCosts: (params) =>
      api.get('/finance/cost/material-standard-costs', { params }),
    freezeMaterialStandardCosts: (data) =>
      api.post('/finance/cost/material-standard-costs/freeze', data),
    updateMaterialStandardCost: (id, data) =>
      api.put(`/finance/cost/material-standard-costs/${id}`, data),
    ...
    getAllocationRulesByParams: (params) =>
      api.get('/finance/cost/overhead-allocation', { params }),
    saveAllocationRule: (data) =>
      data?.id
    ...
    getCostLedgerSummary: (dimension, params) =>
      api.get(`/finance/cost-ledger/summary/${dimension}`, { params }),
    ...
    getEfficiencyVariance: (params) =>
      api.get('/finance/cost-centers/efficiency-variance', { params }),
    getCapacityUtilization: (params) =>
      api.get('/finance/cost-centers/capacity-utilization', { params }),
    ...
    calculateStandardCost: (productId, data) =>
      api.post(`/finance/cost/standard/${productId}/calculate`, data),
  ...
  getAssetDepreciationForecast: (params) =>
    api.get('/finance/assets/depreciation/forecast', { params }),
  assetInventory: {
  ...
  calculateAssetDepreciation: (params) =>
    api.get('/finance/assets/depreciation/calculate', { params }),
  getAssetDepreciationRecords: (params) =>
    api.get('/finance/assets/depreciation/records', { params }),
  ...
  automation: {
    ...
    restartScheduledTask: (taskName) =>
      api.post(`/finance/automation/scheduled-tasks/restart/${taskName}`),
    // 折旧计提
    executeDepreciation: (month) => api.post(`/finance/automation/depreciation/monthly/${month}`),
    executeDepreciationManually: (month) =>
      api.post(`/finance/automation/depreciation/manual/${month}`),
    // 期末结转
    executePeriodEnd: (periodId) =>
      api.post(`/finance/automation/period-end/auto-closing/${periodId}`),
    executePeriodEndManually: (periodId) =>
      api.post(`/finance/automation/period-end/manual-closing/${periodId}`),
    ...
    // 生产成本
    executeProductionCost: (taskId) =>
      api.post(`/finance/automation/production/cost-entry/${taskId}`),
  },
};
