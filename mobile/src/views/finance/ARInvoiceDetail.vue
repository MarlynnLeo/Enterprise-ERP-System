<!--
/**
 * ARInvoiceDetail.vue - 应收发票详情
 * @description 展示应收发票的完整信息
 * @date 2026-04-15
 * @version 1.0.0
 */
-->
<template>
  <div class="detail-page">
    <NavBar title="应收发票详情" left-arrow @click-left="$router.go(-1)" />
    ...
    <div class="detail-body" v-if="invoice">
      ...
      <div class="hero-card">
        ...
        <div class="hero-info">
          <div class="hero-title">{{ invoice.customerName || '未知客户' }}</div>
      ...
      <div class="amount-card">
        ...
        <div class="amount-row">
          <div class="amount-item">
            <span class="amount-label">未收余额</span>
        ...
        <div class="payment-list">
          <div class="payment-item" v-for="p in invoice.payments" :key="p.id">
            <div class="payment-left">
              <div class="payment-date">{{ formatDate(p.receiptDate || p.paymentDate) }}</div>
...
<script setup>
  ...
  const statusMap = {
    ...
    部分付款: { text: '部分收款', cls: 'warning' },
    已付款: { text: '已收款', cls: 'success' },
